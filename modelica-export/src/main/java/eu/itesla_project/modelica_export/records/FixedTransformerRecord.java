...
public class FixedTransformerRecord extends BranchRecord {
    ...
    void setParameters(float snref) {
         ...
         */
        float vEndPu = (float) (v1 / u1Nom);
        float vSourcePu = (float) (v2 / u2Nom);
